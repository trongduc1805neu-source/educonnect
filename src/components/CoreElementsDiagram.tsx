    ...
    <div className="flex flex-col md:flex-row gap-8 items-center justify-center my-12">
      ...
      <div className="flex flex-col gap-4 w-full md:w-64">
        <div className="p-4 border border-zinc-200 bg-zinc-50 rounded-lg relative">
          ...
          <p className="text-sm text-zinc-600">Appears at the very top, often used for branding or quick links</p>
        ...
        <div className="p-4 border border-zinc-200 bg-zinc-50 rounded-lg relative">
          ...
          <p className="text-sm text-zinc-600">Larger section under the navigation, may include banners or page headings</p>
          <div className="hidden md:block absolute right-[-2rem] top-1/2 w-8 border-t border-dashed border-gray-400"></div>
        </div>
        <div className="p-4 border border-zinc-200 bg-zinc-50 rounded-lg relative">
          <h4 className="font-bold text-zinc-900 mb-1">Sidebar</h4>
          <p className="text-sm text-zinc-600">A supplementary column for additional tools or links</p>
          <div className="hidden md:block absolute right-[-2rem] top-1/2 w-8 border-t border-dashed border-gray-400"></div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 w-full md:w-64">
        <div className="p-4 border border-zinc-200 bg-zinc-100 rounded-lg relative">
          ...
          <p className="text-sm text-zinc-600">The menu or bar that helps users navigate the website</p>
        </div>
        <div className="p-4 border border-zinc-200 bg-zinc-50 rounded-lg relative">
          <div className="hidden md:block absolute left-[-2rem] top-1/2 w-8 border-t border-dashed border-gray-400"></div>
          <h4 className="font-bold text-zinc-900 mb-1">Content Area</h4>
          <p className="text-sm text-zinc-600">The main section for the website's core content</p>
        </div>
        <div className="p-4 border border-zinc-200 bg-zinc-50 rounded-lg relative">
          <div className="hidden md:block absolute left-[-2rem] top-1/2 w-8 border-t border-dashed border-gray-400"></div>
          <h4 className="font-bold text-zinc-900 mb-1">Footer</h4>
          <p className="text-sm text-zinc-600">The closing section, usually with secondary information like contacts or policies</p>
        </div>
      </div>
    </div>
  );
