      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 mt-12 mb-12 border-b border-primary-200 pb-8">
        <div>
          ...
          <p className="text-lg text-ink/60 font-light mt-4 leading-relaxed max-w-xl">
            Sắp xếp lớp học, chuẩn bị bài giảng và theo dõi những giá trị bạn
            đang tạo ra mỗi ngày.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="text-[12px] text-ink/60 font-light">
            Trải đều trên{" "}
            <span className="text-primary-700 font-semibold">4 lớp học</span>
          </div>
          <Button
            variant="outline"
            className="w-full mt-8 text-[11px] tracking-widest h-10 border-primary-100 hover:border-primary-300"
        ...
        >
          ...
          <div className="text-[12px] text-ink/60 font-light">
            Phụ huynh đang chờ{" "}
            <span className="text-accent-500 font-semibold">phản hồi sớm</span>
          </div>
          <Button
            variant="outline"
            className="w-full mt-8 text-[11px] tracking-widest h-10 border-primary-100 hover:border-primary-300"
        ...
        >
          ...
          <div className="text-[12px] text-ink/60 font-light">
            Đạt <span className="text-primary-700 font-semibold">80%</span> mục
            tiêu tháng
          </div>
          <Button
            variant="outline"
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="bg-primary-50/40 backdrop-blur-sm rounded-[40px] p-8 lg:p-10 border border-primary-100 paper-shadow">
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-primary-100">
              ...
              <Button
                variant="link"
                className="text-[11px] tracking-widest h-auto p-0 text-primary-700"
              >
                Xem toàn bộ lịch
              </Button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-stretch gap-6 group relative">
                <div className="w-24 text-right shrink-0 py-2 border-r border-primary-100 pr-6">
                  ...
                  <div className="text-[10px] text-ink/40 uppercase tracking-widest mt-1">
                    1.5 GIỜ
                  </div>
                </div>
                <div className="flex-1 py-2">
                  <h3 className="font-heading text-lg text-ink group-hover:text-primary-700 transition-colors">
                    Toán Khối 9 - Học sinh Nguyễn Văn B
                  </h3>
                ...
                <div className="py-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button
                    size="sm"
                    variant="outline"
                    className="text-[10px] h-9 tracking-widest"
                  >
                    ĐIỂM DANH
                  </Button>
                </div>
              ...
              <div className="flex items-stretch gap-6 group relative">
                ...
                <div className="flex-1 py-2">
                  <h3 className="font-heading text-lg text-ink group-hover:text-primary-700 transition-colors">
                    Vật Lý Khối 10 - Học sinh Trần Thị C
                  </h3>
                  <p className="text-[13px] text-ink/60 font-light mt-1 flex items-center gap-2">
          ...
          <div className="bg-primary-50/40 backdrop-blur-sm rounded-[40px] p-8 lg:p-10 border border-primary-100 paper-shadow">
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-primary-100">
              ...
              <span className="text-xs font-light text-ink/50 italic">
                Dành riêng cho chuyên môn của bạn
              </span>
            </div>
            ...
            {loadingRequests ? (
              ...
              <div className="space-y-6">
                {recentRequests.map((req) => (
                  <div
                    key={req.id}
                    className="p-6 rounded-2xl bg-primary-50/50 border border-primary-100 hover:bg-[#FDFBF7] hover:shadow-md transition-all group"
                  >
                    <div className="flex justify-between items-start mb-4">
                      <h3 className="font-heading text-xl text-ink group-hover:text-primary-700 transition-colors">
                        {req.subject} - Khối {req.grade}
                      </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[13px] text-ink/70 font-light mb-6">
                      <div>
                        <strong className="block text-[10px] uppercase tracking-widest text-ink/40 font-bold mb-1">
                          Không gian
                        </strong>
                    ...
                    <Button
                      size="sm"
                      className="text-[10px] h-9 tracking-widest px-6 shadow-sm"
                    >
          ...
          <div className="bg-primary-50/40 backdrop-blur-sm rounded-[40px] p-8 border border-primary-100 paper-shadow">
            ...
            <div className="bg-paper border border-primary-100 rounded-xl p-5 relative overflow-hidden">
              ...
              <p className="text-[12px] text-ink/60 font-light leading-relaxed mb-4">
                Buổi học ngày hôm qua (15/10) với bé Nguyễn Văn B chưa có nhận
                xét. Hãy dành vài phút chia sẻ về sự tiến bộ của con nhé.
              </p>
              <Button
                size="sm"
                className="w-full text-[10px] h-9 tracking-widest shadow-none"
              >
                VIẾT NHẬN XÉT
              </Button>
            </div>
          ...
          <div className="bg-primary-50/40 backdrop-blur-sm rounded-[40px] p-8 border border-primary-100 paper-shadow">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-start group">
                <div>
                  <div className="font-heading text-base text-ink group-hover:text-primary-700 transition-colors">
                    Toán Khối 9
                  </div>
                  <div className="text-[11px] text-ink/40 uppercase tracking-widest mt-1 flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-primary-500" /> Đã
                    giải ngân
                  </div>
                </div>
                <div className="font-heading text-primary-700 text-lg">
                  +400.000đ
                </div>
              </div>
              ...
              <div className="flex justify-between items-start group opacity-60">
                <div>
                  ...
                  <div className="text-[11px] text-ink/40 uppercase tracking-widest mt-1 flex items-center gap-1">
                    <AlertCircle className="w-3 h-3 text-accent-500" /> Chờ xác
                    nhận
                  </div>
                </div>
            ...
            <div className="mt-8 pt-4 border-t border-primary-50">
              <Button
                variant="link"
                className="w-full text-[10px] tracking-widest p-0"
              >
