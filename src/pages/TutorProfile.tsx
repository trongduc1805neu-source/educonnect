            ...
            <section className="bg-primary-900 text-paper p-10 lg:p-14 rounded-3xl relative overflow-hidden">
              ...
              <blockquote className="mb-10 relative z-10">
                <p className="text-2xl lg:text-3xl font-heading italic text-paper leading-snug border-l-[3px] border-accent-500 pl-6 py-2">
                  "Mình tin rằng không có học sinh kém, chỉ là chưa tìm được
                ...
                {tutor.resume.map((item, index) => (
                  <div key={index} className="flex gap-6 lg:gap-10">
                    ...
                    <div className="flex-1 border-l border-primary-200 pl-6 lg:pl-10 pb-6 relative">
                      ...
                      <div className="absolute text-accent-500 font-serif text-xl -left-[9px] -top-3 bg-paper py-1">
                        ✦
                      </div>
                      <div className="font-heading text-2xl text-ink mb-2">
                        {item.title}
                      </div>
                      <div className="text-ink/60 font-light leading-relaxed">
                        {item.desc}
                      </div>
                    </div>
                  </div>
            ...
            <section>
              <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-ink/40 mb-10 flex items-center justify-between">
                <span className="flex items-center gap-3">
                  <MessageCircle className="w-4 h-4" /> Lời nhắn từ học viên
                </span>
              </h3>
              ...
              <div className="space-y-10">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="pb-10 border-b border-primary-100 last:border-0 last:pb-0"
                  >
                    ...
                    <p className="text-ink/70 font-light leading-relaxed text-[15px] italic">
                      "Thầy dạy rất nhiệt tình và dễ hiểu. Từ một đứa sợ môn
                      Toán, giờ em đã tự tin hơn rất nhiều và có thể tự giải
                      được các bài tập khó. Cảm ơn thầy nhiều ạ!"
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-[#FDFBF7] rounded-3xl p-8 border border-primary-100 paper-shadow">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <div className="text-[10px] font-bold text-ink/40 uppercase tracking-widest mb-1">
                      Học phí đầu tư
                    </div>
                    <div className="text-4xl font-heading text-primary-700">
                      {tutor.fee}
                    </div>
                    <div className="text-[12px] text-ink/40 font-medium mt-1">
                      / giờ học
                    </div>
                  </div>
                ...
                <Button
                  ...
                  className="w-full h-14 text-xs tracking-widest shadow-md"
                >
              ...
              <div className="bg-[#FDFBF7] rounded-3xl p-8 border border-primary-100 paper-shadow">
                <div className="grid grid-cols-2 gap-8 divide-x divide-primary-100">
                  <div className="text-center">
                    <div className="text-3xl font-heading text-ink mb-1">
                      {tutor.responseRate}
                    </div>
                    <div className="text-[10px] text-ink/40 uppercase font-bold tracking-widest">
                      Tỉ lệ phản hồi
                    </div>
                  </div>
