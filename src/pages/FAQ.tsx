...
const FAQ_DATA = [
  {
    ...
    answer:
      "Bạn có thể sử dụng chức năng 'Tìm Gia Sư', nhập các yêu cầu về môn học, khu vực, học phí và mục tiêu. Hệ thống sẽ đề xuất những gia sư phù hợp nhất. Bạn cũng có thể xem hồ sơ chi tiết, đánh giá và đặt lịch học thử.",
  },
  {
    id: 2,
    category: "Dành cho Phụ huynh & Học viên",
    ...
    answer:
      "EduConnect khuyến khích các gia sư cung cấp một buổi học thử miễn phí hoặc có phí ưu đãi để hai bên làm quen và đánh giá mức độ phù hợp trước khi quyết định học chính thức.",
  },
  {
    id: 3,
    ...
    answer:
      "Bạn cần cung cấp thông tin cá nhân, định danh, thẻ sinh viên/bằng cấp, và chứng chỉ liên quan. Hồ sơ sẽ được đội ngũ EduConnect kiểm duyệt trong vòng 24-48h trước khi bạn có thể nhận lớp.",
  },
  {
    id: 4,
    ...
    answer:
      "Phụ huynh và học viên hoàn toàn miễn phí khi sử dụng nền tảng. Đối với gia sư, chúng tôi thu một khoản phí kết nối nhỏ (tính trên tháng học đầu tiên) nhằm duy trì và phát triển tính năng của nền tảng.",
  },
  {
    id: 5,
    category: "Dành cho Gia sư",
    ...
    answer:
      "Sau khi hồ sơ được duyệt, bạn có thể truy cập mục 'Tìm Lớp' để gửi yêu cầu nhận lớp tới những lớp đang mở, hoặc chờ phụ huynh chủ động liên hệ gửi lời mời dạy tới bạn thông qua hồ sơ trực tuyến.",
  },
  {
    id: 6,
    category: "Thanh toán & Phí dịch vụ",
    ...
    answer:
      "Học phí có thể được thanh toán trực tiếp cho gia sư hoặc thông qua cổng thanh toán trung gian an toàn của EduConnect. Chúng tôi khuyến nghị trao đổi rõ ràng phương thức thanh toán ngay từ buổi học đầu tiên.",
  },
  {
    id: 7,
    category: "Dành cho Phụ huynh & Học viên",
    ...
    answer:
      "Trong trường hợp không hài lòng sau buổi học đầu tiên hoặc quá trình học tập không như mong đợi, bạn có thể phản hồi trực tiếp qua tính năng đánh giá hoặc liên hệ Hotline hỗ trợ của EduConnect để được đổi gia sư miễn phí.",
  },
];
          ...
          {filteredFAQs.length > 0 ? (
            filteredFAQs.map((faq) => (
              ...
              >
                ...
                >
                  <h3
                    className={`text-xl md:text-2xl font-heading pr-4 transition-colors duration-300 ${openItem === faq.id ? "text-primary-700" : "text-ink group-hover:text-primary-700"}`}
                  >
                    {faq.question}
                  </h3>
                  <div
                    className={`shrink-0 transition-colors duration-300 ${openItem === faq.id ? "text-primary-700" : "text-ink/30 group-hover:text-primary-500"}`}
                  >
                    {openItem === faq.id ? (
            ...
            >
              ...
              <p className="text-ink/60 font-medium">
                Trống! Không tìm thấy kết quả phù hợp.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
