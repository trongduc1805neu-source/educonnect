  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-1 space-y-6">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Tìm gia sư dạy kèm tại nhà</h1>
          <p className="text-slate-600">Đội ngũ gia sư chất lượng cao, sẵn sàng đến tận nhà giảng dạy trong khu vực của bạn.</p>
        </div>
          ...
          <div className="grid gap-4">
            {MOCK_TUTORS.map((tutor, idx) => (
              <motion.div 
                ...
                className="flex flex-col sm:flex-row gap-6 rounded-2xl bg-white p-6 shadow-sm border border-slate-100 hover:border-indigo-100 hover:shadow-md transition-all"
              >
                ...
                <div className="flex sm:flex-col justify-end gap-2 shrink-0">
                  ...
                  <Button className="w-full sm:w-auto">Đặt lịch học</Button>
                </div>
              </motion.div>
            ))}
          </div>
