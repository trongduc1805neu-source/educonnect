...
const MOCK_CLASSES = [
  ...
  {
    id: 2,
    title: "Phân tích định lượng SPSS",
    tutor: "Cô Khánh Lê",
...
export function EditorClasses() {
  ...
  const [formData, setFormData] = useState<(typeof MOCK_CLASSES)[0] | null>(
    null,
  );
          ...
          <div className="sticky top-28 space-y-6">
            <div className="border-b border-primary-200 pb-2 mb-6 flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase tracking-widest text-ink/40 flex items-center gap-2">
                <BookOpen className="w-3 h-3" /> Các lớp đang mở
              </span>
            </div>
            ...
            <div className="space-y-4">
              {classes.map((cls) => (
                ...
                >
                  <div className="text-[10px] font-bold uppercase tracking-widest text-primary-700 mb-2">
                    {cls.startDate}
                  </div>
                  <h3 className="font-heading text-lg text-ink leading-tight mb-3">
                    {cls.title}
                  </h3>
              ...
              >
                <div className="absolute top-6 right-6">
                  <button
                    ...
                    className="p-2 bg-paper rounded-full text-ink/40 hover:text-ink transition-colors border border-primary-100"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="VD: Luyện thi Ngữ Văn 12..."
                      className="w-full bg-transparent border-0 border-b border-primary-200 py-2 px-0 text-xl font-heading text-ink focus:ring-0 focus:border-primary-700 placeholder:text-ink/20"
                    />
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full bg-transparent border-0 border-b border-primary-200 py-3 px-0 text-ink focus:ring-0 focus:border-primary-700 appearance-none rounded-none cursor-pointer"
                      >
                        <option value="" disabled>
                          --- Chọn Giáo viên ---
                        </option>
                        <option value="Thầy Nguyễn Hải Anh">
                          Thầy Nguyễn Hải Anh
                        </option>
                        <option value="Cô Khánh Lê">Cô Khánh Lê</option>
                        <option value="Cô Trần Phương Ly">
                          Cô Trần Phương Ly
                        </option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <option value="offline">
                          Trực tiếp (Tại nhà/Trung tâm)
                        </option>
                        <option value="online">
                          Trực tuyến (Google Meet/Zoom)
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    {/* Khai giảng */}
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-widest text-ink/40 mb-2 flex items-center gap-1">
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border-0 border-b border-primary-200 py-2 px-0 text-ink focus:ring-0 focus:border-primary-700 placeholder:text-ink/20"
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-widest text-ink/40 mb-2 flex items-center gap-1">
                        <Users className="w-3 h-3" /> Sĩ số Tối Đa
                      </label>
                      <input
                        name="capacity"
                        required
                  ...
                  <div className="w-full md:w-1/3">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border-0 border-b border-primary-200 py-2 px-0 text-xl font-heading text-primary-700 focus:ring-0 focus:border-primary-700 placeholder:text-ink/20"
                    />
                  </div>
                  ...
                  <div className="pt-8 border-t border-primary-100 flex justify-end">
                    <Button
                      type="submit"
                      className="text-xs tracking-widest h-12 px-10 shadow-md"
                    >
              ...
              <div className="h-full flex items-center justify-center min-h-[300px]">
                <div className="text-center">
                  ...
                  <p className="text-[13px] text-ink/40 font-light max-w-xs mx-auto italic">
                    Chọn một lớp học từ danh sách để thiết lập không gian, hoặc
                    thêm mới để mở rộng cơ hội học tập.
                  </p>
                </div>
              </div>
            )}
