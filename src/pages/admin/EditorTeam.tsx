      ...
      <header className="mb-16 border-b border-primary-200 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl lg:text-5xl font-heading text-ink mb-2">
            Những người{" "}
            <span className="italic text-primary-700 font-light">giữ lửa.</span>
          </h1>
        ...
        <Button
          ...
          variant="outline"
          className="text-xs tracking-widest shadow-none hover:bg-primary-50 self-start md:self-auto"
        >
          THÊM THÀNH VIÊN
        </Button>
      </header>
                ...
                >
                  <div className="w-12 h-12 rounded-lg bg-primary-100 overflow-hidden shrink-0 border border-primary-200">
                    {member.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-primary-300 font-heading text-xl">
            ...
            {editingId !== null ? (
              ...
              >
                <div className="absolute top-6 right-6">
                  <button
                    ...
                    className="p-2 text-ink/30 hover:text-ink hover:bg-primary-50 rounded-full transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        {previewImage ? (
                          <>
                            <img
                              src={previewImage}
                              alt="Preview"
                              className="w-full h-full object-cover filter grayscale-[20%] group-hover:grayscale-0 transition-all"
                            />
                            <div className="absolute inset-0 bg-ink/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                              <span className="text-[10px] text-white font-bold uppercase tracking-widest bg-ink/50 px-3 py-1 rounded-full backdrop-blur-sm">
                                Thay đổi
                              </span>
                            </div>
                          </>
                  ...
                  <div className="pt-6 border-t border-primary-100 flex justify-end">
                    <Button
                      type="submit"
                      className="text-xs tracking-widest h-12 px-10 shadow-md bg-ink text-white hover:bg-ink/80"
                    >
                      LƯU BẢN THẢO
                    </Button>
                  </div>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-12 border border-dashed border-primary-200 rounded-3xl bg-primary-50/10">
                ...
                <h3 className="font-heading text-2xl text-ink/40 mb-2">
                  Bàn biên tập đang trống
                </h3>
                <p className="text-sm text-ink/40 font-light font-sans max-w-sm">
                  Chọn một nhân vật từ thư mục bên trái để bắt đầu chỉnh sửa,
                  hoặc thêm mới để mở rộng đội ngũ.
                </p>
              </div>
            )}
          </AnimatePresence>
