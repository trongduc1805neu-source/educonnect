...
const INITIAL_TEAM = [
  ...
  {
    id: 2,
    name: "Lê Nguyễn Thu Uyên",
    role: "Giám đốc Sản phẩm",
    image:
      "https://i.ibb.co/SF32x32/649080250-1480301896998131-8534730828073620253-n.jpg",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image: "https://i.ibb.co/TqhHK8Lw/image.png",
  },
  {
    id: 5,
    name: "Nguyễn Ngân Hà",
    ...
    image:
      "https://images.unsplash.com/photo-1598550874175-4d0ef436c909?q=80&w=600&auto=format&fit=crop",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-24 pb-24 px-6 mt-8">
      ...
      <header className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        <div>
          ...
          <p className="text-lg text-ink/70 font-light leading-relaxed">
            EduConnect ra đời từ một niềm tin giản dị: Mỗi học sinh đều xứng
            đáng có một người dẫn đường thấu cảm. Chúng tôi không chỉ xây dựng
            một nền tảng công nghệ, chúng tôi đang dệt nên một mạng lưới của sự
            tin tưởng, minh bạch và khát khao tri thức tại Việt Nam.
          </p>
        </div>
        <div className="relative hidden lg:block lg:mt-6 z-0">
          ...
          >
            <p className="text-[15px] italic text-ink/80 leading-relaxed mb-6 font-medium">
              "Tại EduConnect, chúng tôi xem giáo dục là hành trình kết nối
              những trái tim thấu cảm để kiến tạo những khối óc tinh hoa."
            </p>
      ...
      <div className="grid md:grid-cols-3 gap-12 py-16 border-y border-primary-100">
        <motion.div
          whileHover={{ y: -5 }}
          className="space-y-4 group flex flex-col"
        >
          ...
          <p className="text-[15px] text-ink/70 font-light leading-relaxed text-justify">
            Kết nối những tâm hồn đồng điệu trong giáo dục. Giúp việc tìm kiếm
            người dạy trở nên dễ dàng, xóa bỏ những rào cản về chi phí trung
            gian và nâng tầm chất lượng học tập.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-[15px] text-ink/70 font-light leading-relaxed text-justify">
            Trở thành không gian giáo dục công nghệ tinh hoa, nơi sự thấu cảm
            của con người được nâng bước bởi trí tuệ nhân tạo, nhằm cá nhân hóa
            trọn vẹn hành trình tiếp thu tri thức.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-[15px] text-ink/70 font-light leading-relaxed text-justify">
            Kiến tạo một môi trường học tập an toàn tuyệt đối. Nơi tài năng của
            người dạy được tôn vinh xứng đáng, và quyền lợi của người học được
            bảo vệ trọn vẹn.
          </p>
        </motion.div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-ink/60 font-light text-lg">
              Sự kết hợp giữa tư duy công nghệ nhạy bén và trái tim mang nhịp
              đập của giáo dục thực chứng.
            </p>
          </div>
        </div>
          ...
          {TEAM.map((member, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3 className="font-heading text-xl md:text-2xl text-ink">
                    {member.name}
                  </h3>
                  <p className="text-[10px] md:text-xs font-bold text-accent-500 uppercase tracking-widest mt-2">
                    {member.role}
                  </p>
                </motion.div>
              </motion.div>
